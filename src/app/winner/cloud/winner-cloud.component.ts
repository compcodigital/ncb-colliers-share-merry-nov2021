import { Component, OnInit, TemplateRef, ViewChild, Input, ElementRef, AfterViewInit, HostListener, OnDestroy } from '@angular/core';
...
@Component({
  selector: 'app-winner-cloud',
  templateUrl: './winner-cloud.component.html',
  styleUrls: ['./winner-cloud.component.scss']
})
export class WinnerCloudComponent implements OnInit, AfterViewInit, OnDestroy {
  prizeInfo: string;
  ...
  constructor(
    ...
    this.src = '../assets/img/scratch/scratchwinner.jpg';
